...
// eslint-disable-next-line @typescript-eslint/naming-convention -- companion type shares the const's name deliberately (const-object + derived-union-type pattern)
...
export function sort_skill_event(a: SkillEventType, b: SkillEventType) {
