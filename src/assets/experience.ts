...
const first_job_end = new Date("2025-04-01T16:00:00.000+09:30");
...
const amazon_start = new Date("2025-04-28T09:00:00.000+10:00");
...
export const experience: { [id: string]: Experience } = {
	...
	"game-maker": {
		...
		skills: [
			{
				skill: SKILL.GAMEMAKER,
				events: [SKILL_EVENT_TYPE.BEGIN, SKILL_EVENT_TYPE.LEARN],
			},
		],
		awards: [],
	},
	"minecraft-dev": {
		...
		type: "learning",
		skills: [
			{ skill: SKILL.DEPLOYMENT, events: [SKILL_EVENT_TYPE.BEGIN] },
			{ skill: SKILL.JAVA, events: [SKILL_EVENT_TYPE.BEGIN] },
		],
		awards: [],
	},
	"game-dev": {
		...
		type: "hobby",
		skills: [
			{ skill: SKILL.GAMEMAKER, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.JAVA, events: [SKILL_EVENT_TYPE.LEARN] },
		],
		awards: [
			{
				type: AWARD_TYPE.CERTIFICATE,
				title: "Introduction to Game Development",
				description: "Completion of a 3-day bootcamp at Flinders University",
			},
			{
	...
	"intense-java": {
		...
		type: "hobby",
		skills: [
			{ skill: SKILL.JAVA, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.DEPLOYMENT, events: [SKILL_EVENT_TYPE.LEARN] },
		],
		awards: [],
	},
	mcdonalds: {
		...
		awards: [
			{
				...
				description: "Will achieve in 2024, from the University of Adelaide",
			},
		],
	},
	"badminton-coach": {
	...
	"hive-aid": {
		...
		skills: [
			{
				skill: SKILL.PHP,
				events: [SKILL_EVENT_TYPE.LEARN, SKILL_EVENT_TYPE.BEGIN],
			},
			{ skill: SKILL.HTML, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.CSS, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.SQL, events: [SKILL_EVENT_TYPE.LEARN] },
			{ skill: SKILL.DEPLOYMENT, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.JAVASCIPRT, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.AGILE, events: [SKILL_EVENT_TYPE.BEGIN] },
		],
		awards: [],
	},
	amazon: {
		...
		skills: [
			...
			{ skill: SKILL.DEPLOYMENT, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.JAVASCIPRT, events: [SKILL_EVENT_TYPE.MASTER] },
			{ skill: SKILL.AWS, events: [SKILL_EVENT_TYPE.BEGIN] },
			{ skill: SKILL.AGILE, events: [SKILL_EVENT_TYPE.LEARN] },
		],
		awards: [],
	},
};
