...
import { get_experience_relating_to_skill } from "./experience";
...
export const skills: { [id: Skill]: SkillInformation } = {
	[SKILL.JAVA]: {
		experience: get_experience_relating_to_skill(SKILL.JAVA),
		description:
	...
	[SKILL.GAMEMAKER]: {
		experience: get_experience_relating_to_skill(SKILL.GAMEMAKER),
		description:
